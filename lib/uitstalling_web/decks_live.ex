defmodule UitstallingWeb.DecksLive do
  @moduledoc "The presentations home: deck list and the New presentation button."
        ...
        <header class="flex items-end justify-between flex-wrap gap-6">
          <div>
            <p class="font-mono text-amber-400 text-sm tracking-widest uppercase">
              <.link navigate={~p"/"} class="text-zinc-600 hover:text-amber-400">UIT</.link>
              · presentations
            </p>
          ...
          <.link
            :if={not @author?}
            navigate={~p"/auth/login?return_to=/decks"}
